 ...
 */
return array(
	'title'      => __( 'Blog footer', 'dynamic-drive' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"var(--wp--custom--spacing--large, 8rem)"}}},"layout":{"inherit":true}} -->
					...
					<p style="text-transform:uppercase">' . esc_html__( 'About us', 'dynamic-drive' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph -->
					<p>' . esc_html__( 'We are a rogue collective of bird watchers. We’ve been known to sneak through fences, climb perimeter walls, and generally trespass in order to observe the rarest of birds.', 'dynamic-drive' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->

					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase"}}} -->
					<p style="text-transform:uppercase">' . esc_html__( 'Latest posts', 'dynamic-drive' ) . '</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase"}}} -->
					<p style="text-transform:uppercase">' . esc_html__( 'Categories', 'dynamic-drive' ) . '</p>
					<!-- /wp:paragraph -->
					...
					sprintf(
						...
						esc_html__( 'Proudly powered by %s', 'dynamic-drive' ),
						'<a href="' . esc_url( __( 'https://wordpress.org', 'dynamic-drive' ) ) . '" rel="nofollow">WordPress</a>'
					) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
