 ...
 * @return void
 */
function dynamicdrive_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'dynamic-drive' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'dynamic-drive' ) ),
		'header'   => array( 'label' => __( 'Headers', 'dynamic-drive' ) ),
		'query'    => array( 'label' => __( 'Query', 'dynamic-drive' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'dynamic-drive' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'dynamicdrive_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'dynamicdrive_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'dynamicdrive/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'dynamicdrive_register_block_patterns', 9 );
